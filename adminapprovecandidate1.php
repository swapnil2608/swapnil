...
<div id="wrapper">
	...
	<!-- end #header -->
	<div id="menu">
		<ul>	<li ><a href="adminhome1.php">Home</a></li>
...
{ 
    ...
    $r=$_REQUEST['cid'];
    $select="delete from candidate_reg where C_id=".$r;
    if(Blogic::execute_query($select))
    {
        echo "<center><font color='green'>Record Deleted</font></center>";
    }
...
?>
<center><a href="admincandidateaccount.php">Go Back....</a></center>
<!-- end #page --> 
</div>
<div id="footer">
