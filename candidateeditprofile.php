...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<li class="current_page_item"><a href="#">Edit Profile</a></li>
  ...
  if(isset($_REQUEST['sub']) )
{
   ...
   $select="update candidate_reg set firstname='$firstname',lastname='$lastname',Dob='$dob',gen='$gen',pincode=$pincode,fathername='$fathername',state='$state',city='$city',party='$party',type='$type',email='$email',address='$address',contact='$contact',er='$er',v_id='$vid' where c_username='$n'";
